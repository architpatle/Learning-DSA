...
/*  1. In this An array is given, each value tells the number of minutes it will take to paint the particular boat
    2. n = number of boats, m = Number of painters
    3. Objective is to find minimum duration to paint all the boats
    4. TC : O(log sum * n) 
*/
...
int main()
{
    vector<int> boats = {40, 30, 20, 10};
    int n = 4, m = 2;

    cout << minTimeToPaint(boats, n, m);
    return 0;
}